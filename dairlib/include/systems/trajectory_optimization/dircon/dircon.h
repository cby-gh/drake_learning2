...
Eigen::MatrixXd GetForce_C_SamplesByMode(
    const  drake::solvers::MathematicalProgramResult& result, int mode) const;
     
Eigen::MatrixXd GetGamma_C_SamplesByMode(
    const  drake::solvers::MathematicalProgramResult& result, int mode) const;
  ...
  const drake::solvers::VectorXDecisionVariable input_vars(
    ...
    const drake::solvers::VectorXDecisionVariable floatfoot_collosionavoidence_rel_offset_vars(int mode_index, int knot_index) const ;
 ...
 private:
  ...
  std::vector<drake::solvers::VectorXDecisionVariable> mode_duration_vars_;
  ...
  std::vector<drake::solvers::VectorXDecisionVariable> floatfoot_collosionavoidence_rel_offset_vars_;
};
