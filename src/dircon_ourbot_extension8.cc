...
#include "extension8_trajectory.h"
...
// planar_z = 1
  ...
  trajopt.AddLinearConstraint(xf(positions_map["joint_left_knee"]) ==x0(positions_map["joint_right_knee"]));
  trajopt.AddLinearConstraint(xf(positions_map["joint_right_knee"]) ==x0(positions_map["joint_left_knee"]));
  ...
  trajopt.AddLinearConstraint(x0(nq + velocities_map["joint_left_kneedot"])  ==xf(nq + velocities_map["joint_right_kneedot"]) );
    ...
    //trajopt.AddLinearConstraint(x0(nq + velocities_map["joint_right_hipdot"])  <=-2.5);
     //trajopt.AddLinearConstraint(x0(nq + velocities_map["joint_left_hipdot"])  >=-1.5);
  //trajopt.AddLinearConstraint(x0(nq + velocities_map["joint_left_hipdot"])  <=-0.2 );
 // trajopt.AddLinearConstraint(x0(nq + velocities_map["joint_right_kneedot"])  ==xf(nq + velocities_map["joint_left_kneedot"]) );
  //trajopt.AddLinearConstraint(x0(nq + velocities_map["joint_left_kneedot"])  ==xf(nq + velocities_map["joint_right_kneedot"]) );
  //trajopt.AddLinearConstraint(x0(nq + velocities_map["joint_right_hipdot"])  ==0.0);
  //trajopt.AddLinearConstraint(x0(nq + velocities_map["joint_left_hipdot"])  ==0.0);
  //trajopt.AddLinearConstraint(x0(nq + velocities_map["joint_right_kneedot"])  ==0.0);
  //trajopt.AddLinearConstraint(x0(nq + velocities_map["joint_left_kneedot"])  ==0.0);
...
//force_vars是每个knot point处的力变量，设置每个knot处的y方向的约束力为0，因为只有平面   
  ...
  drake::solvers::VectorXDecisionVariable x_right_ankle(19);
  drake::solvers::VectorXDecisionVariable x_dot_right_ankle(19);
  drake::solvers::VectorXDecisionVariable x_left_ankle(19);
  drake::solvers::VectorXDecisionVariable x_dot_left_ankle(19);
  for(int i=0;i<19;i++)
  {
  ...
  const double Q = 16;  // Cost on total state 
  const double L = 16;  // Cost on hip position   good=10
  const double M = 8;  // Cost on hip velocity    good=10
  const double N = 1;  // Cost on knee position   good=10 
  const double O = 1;  // Cost on knee   velocity   good=10   sss
  ...
  //trajopt.AddRunningCost(x_right_hip.transpose()*L*x_right_hip);//good,关键
  //trajopt.AddRunningCost(x_left_knee.transpose()*N*x_left_knee);//开始晃了不加hip的约束
 // trajopt.AddRunningCost(x_right_knee.transpose()*N*x_right_knee);//开始晃了不加hip的约束
      ...
      for(int t = 0;t<100;t++)
    {
      ...
      std::cout << "tttttttttt: "  <<t<<std::endl;
        ...
        std::cout << "result_x:right_hip_pindot: "  <<result_x[t](10)<<std::endl;
         ...
         std::cout << "rhdot1: "  <<pp_xtraj.value(1)(10,0)<<std::endl;        
         std::cout << "lhdot1: "  <<pp_xtraj.value(1)(11,0)<<std::endl;      
         std::cout << "rkdot1: "  <<pp_xtraj.value(1)(12,0)<<std::endl;        
         std::cout << "lkdot1: "  <<pp_xtraj.value(1)(13,0)<<std::endl;    
std::cout << "rhdot0.999: "  <<pp_xtraj.value(0.99)(10,0)<<std::endl;    
std::cout << "lhdot0.999: "  <<pp_xtraj.value(0.99)(11,0)<<std::endl;       
std::cout << "rhdot0.1: "  <<pp_xtraj.value(0.0)(10,0)<<std::endl;    
std::cout << "rhdot0.1: "  <<pp_xtraj.value(0.1)(10,0)<<std::endl;    
std::cout << "rhdot0.1: "  <<pp_xtraj.value(0.2)(10,0)<<std::endl;    
std::cout << "rhdot0.1: "  <<pp_xtraj.value(0.3)(10,0)<<std::endl;    
std::cout << "rhdot0.1: "  <<pp_xtraj.value(0.4)(10,0)<<std::endl;    
std::cout << "rhdot0.1: "  <<pp_xtraj.value(0.5)(10,0)<<std::endl;    
std::cout << "rhdot0.1: "  <<pp_xtraj.value(0.6)(10,0)<<std::endl;    
std::cout << "rhdot0.1: "  <<pp_xtraj.value(0.7)(10,0)<<std::endl;   
std::cout << "rhdot0.1: "  <<pp_xtraj.value(0.8)(10,0)<<std::endl;   
std::cout << "rhdot0.1: "  <<pp_xtraj.value(0.9)(10,0)<<std::endl;   
std::cout << "rhdot0.1: "  <<pp_xtraj.value(10)(10,0)<<std::endl;   
std::cout << "lhdot0.1: "  <<pp_xtraj.value(0.0)(11,0)<<std::endl; 
std::cout << "lhdot0.1: "  <<pp_xtraj.value(0.1)(11,0)<<std::endl;      
std::cout << "lhdot0.1: "  <<pp_xtraj.value(0.2)(11,0)<<std::endl;      
std::cout << "lhdot0.1: "  <<pp_xtraj.value(0.3)(11,0)<<std::endl;      
std::cout << "lhdot0.1: "  <<pp_xtraj.value(0.4)(11,0)<<std::endl;      
std::cout << "lhdot0.1: "  <<pp_xtraj.value(0.5)(11,0)<<std::endl;      
std::cout << "lhdot0.1: "  <<pp_xtraj.value(0.6)(11,0)<<std::endl;      
std::cout << "lhdot0.1: "  <<pp_xtraj.value(0.7)(11,0)<<std::endl;      
std::cout << "lhdot0.1: "  <<pp_xtraj.value(0.8)(11,0)<<std::endl;      
std::cout << "lhdot0.1: "  <<pp_xtraj.value(0.9)(11,0)<<std::endl;      
std::cout << "lhdot0.1: "  <<pp_xtraj.value(10)(11,0)<<std::endl;            
    /* for(int t = 0;t<100;t++)
    {
...
//        std::cout <<" plant->get_actuation_input_port().HasValue()"<<plant->get_actuation_input_port().HasValue(*contextnow)<<std::endl;     
 ...
 //   }    
   ...
   int result1 = access("/home/cby/drake_learning/src/drake_learning1/src/x_planed_outsearch_select0.txt", 0);//加入先验条件时,需要撤去文件名称的xxx
   int result2 = access("/home/cby/drake_learning/src/drake_learning1/src/u_planed_outsearch_select0.txt", 0);
  if(result1==0&&result2==0)
  {
   ...
   // std::cout << "init_l_j:init_lc_j:init_vc_j.size() "  <<init_l_j.size()<<init_lc_j.size()<<init_vc_j.size()<<std::endl;
        int result3 = access("/home/cby/drake_learning/src/drake_learning1/src/lammda_planed_outsereach_select0.txt", 0);//加入先验条件时,需要撤去文件名称的xxx
        int result4 = access("/home/cby/drake_learning/src/drake_learning1/src/lammda_c_planed_outsereach_select0.txt", 0);
        int result5 = access("/home/cby/drake_learning/src/drake_learning1/src/gammda_c_planed_outsereach_selsect0.txt", 0);
